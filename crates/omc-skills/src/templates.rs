...
pub fn get_templates() -> HashMap<String, SkillTemplate> {
    ...
    templates.insert(
        ...
        SkillTemplate {
            metadata: SkillMetadata {
                name: "tdd".to_string(),
                description: "Test-driven development with red-green-refactor loop. Use when user wants to build features or fix bugs using TDD, mentions red-green-refactor, wants integration tests, or asks for test-first development.".to_string(),
                argument_hint: None,
                level: Some("3".to_string()),
                aliases: vec![],
                agent: None,
            ...
            content: include_str!("templates/tdd.md").to_string(),
        },
    );
    ...
    templates.insert(
        ...
        SkillTemplate {
            metadata: SkillMetadata {
                ...
                description: "Disciplined diagnosis loop for hard bugs and performance regressions. Reproduce, minimise, hypothesise, instrument, fix, regression-test. Use when user says diagnose this / debug this, reports a bug, says something is broken/throwing/failing, or describes a performance regression.".to_string(),
                argument_hint: None,
                level: Some("3".to_string()),
                aliases: vec![],
                agent: None,
            ...
            content: include_str!("templates/diagnose.md").to_string(),
        },
    );
    ...
    templates.insert(
        ...
        SkillTemplate {
            metadata: SkillMetadata {
                ...
                description: "Find deepening opportunities in a codebase, informed by the domain language in CONTEXT.md and the decisions in docs/adr/. Use when the user wants to improve architecture, find refactoring opportunities, consolidate tightly-coupled modules, or make a codebase more testable and AI-navigable.".to_string(),
                argument_hint: None,
                level: Some("advanced".to_string()),
                aliases: vec!["iba".to_string()],
                agent: None,
                model: None,
                hosts: vec![],
                protocol_version: None,
            },
            content: include_str!("templates/improve-codebase-architecture.md").to_string(),
        },
    );
    ...
    templates.insert(
        ...
        SkillTemplate {
            metadata: SkillMetadata {
                ...
                argument_hint: None,
                level: Some("2".to_string()),
                aliases: vec!["proto".to_string()],
                agent: None,
                model: None,
                hosts: vec![],
                protocol_version: None,
            },
            content: include_str!("templates/prototype.md").to_string(),
        },
    );
    ...
    templates.insert(
        ...
        SkillTemplate {
            metadata: SkillMetadata {
                ...
                description: "Triage issues through a state machine driven by triage roles. Use when user wants to create an issue, triage issues, review incoming bugs or feature requests, prepare issues for an AFK agent, or manage issue workflow.".to_string(),
                argument_hint: None,
                level: Some("2".to_string()),
                aliases: vec![],
                agent: None,
            ...
            content: include_str!("templates/triage.md").to_string(),
        },
    );
    ...
    templates.insert(
        ...
        SkillTemplate {
            metadata: SkillMetadata {
                name: "to-issues".to_string(),
                description: "Break a plan, spec, or PRD into independently-grabbable issues on the project issue tracker using tracer-bullet vertical slices. Use when user wants to convert a plan into issues, create implementation tickets, or break down work into issues.".to_string(),
                argument_hint: None,
                level: Some("2".to_string()),
                aliases: vec!["ti".to_string()],
                agent: None,
                model: None,
                hosts: vec![],
                protocol_version: None,
            },
            content: include_str!("templates/to-issues.md").to_string(),
        },
    );
