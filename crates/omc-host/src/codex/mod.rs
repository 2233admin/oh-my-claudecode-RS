...
mod tests {
    ...
    fn register_skills_multiple_sources() {
        ...
        assert!(root.join(".codex/skills/alpha/SKILL.md").exists());
        assert!(root.join(".codex/skills/beta/SKILL.md").exists());
    }
}
